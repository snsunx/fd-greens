...
def main() -> None:
    ...
    parser.add_argument("-n", "--noise", type=str, dest="noise_fname")
    parser.add_argument("-c", "--circuit", type=str, dest="circuit_name")
    ...
    if args.circuit_name is None:
        ...
        create_resp_hdf5_by_depth(args.h5fname, args.circuit_name, noise_fname=args.noise_fname)
