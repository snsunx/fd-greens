...
then
    python3 process_results.py nah_greens_tomo_expt   nah_greens_exact nah_greens_tomo_results
    python3 process_results.py nah_greens_tomo2q_expt nah_greens_exact nah_greens_tomo2q_results
    python3 process_results.py kh_greens_tomo_expt    kh_greens_exact  kh_greens_tomo_results
    python3 process_results.py kh_greens_tomo2q_expt  kh_greens_exact  kh_greens_tomo2q_results
    # for h5fname_expt in nah_greens_tomo2q_raw nah_greens_tomo2q_pur nah_greens_tomo2q_trace
    # do
    #     python3 process_results.py $h5fname_expt nah_greens_exact nah_greens_tomo2q_results
    # done

    # for h5fname_expt in kh_greens_tomo_raw kh_greens_tomo_pur kh_greens_tomo_trace
    # do
    #     python3 process_results.py $h5fname_expt kh_greens_exact kh_greens_tomo_results
    # done

    # for h5fname_expt in kh_greens_tomo2q_raw kh_greens_tomo2q_pur kh_greens_tomo2q_trace
    # do
    #     python3 process_results.py $h5fname_expt kh_greens_exact kh_greens_tomo2q_results
    # done
fi
...
then
    ...
    for h5fname in nah_greens_tomo_expt nah_greens_tomo2q_expt kh_greens_tomo_expt kh_greens_tomo2q_expt
    do
        python3 generate_data.py --observable $h5fname
