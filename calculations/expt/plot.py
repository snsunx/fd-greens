...
def main_1p6A():
    ...
    labels = ['Exact', 'Expt']
    annotations_A = [dict(x=0.23, y=0.8, s='Exact', color='C0'), dict(x=0.58, y=0.5, s='Expt', color='C1')]
    annotations_TrS = [dict(x=0.73, y=0.7, s='Exact (real)', color='xkcd:red'),
    ...
    linestyles_TrS = [{'color': 'xkcd:red'}, {'color': 'xkcd:blue'}, 
...
def main_3A():
    ...
    suffixes = ['_d', '_d_exp_proc']
    labels = ['Exact', 'Expt']
    annotations_A = [dict(x=0.56, y=0.8, s='Exact', color='C0'), dict(x=0.6, y=0.45, s='Expt', color='C1')]
    annotations_TrS = [dict(x=0.73, y=0.7, s='Exact (real)', color='xkcd:red'),
...
def main_chi():
    ...
    labels = ['Exact', 'Expt']
    annotations = [dict(x=0.22, y=0.16, s='Exact (real)', color='xkcd:red'), 
    ...
    linestyles = [{'color': 'xkcd:red'}, {'color': 'xkcd:blue'}, 
