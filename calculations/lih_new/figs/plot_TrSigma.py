...
omegas, re_lih_tomo_TrS, im_lih_tomo_TrS = np.loadtxt('../data/lih_tomo_TrSigma.dat').T

fig, ax = plt.subplots()
ax.plot(omegas, reTrS_red_sv, label="Real, SV")
ax.plot(omegas, imTrS_red_sv, label="Imag, SV")
ax.plot(omegas, re_lih_tomo_TrS, color='C0', ls='--', marker='x', markevery=20, label="Real, QASM")
ax.plot(omegas, im_lih_tomo_TrS, color='C1', ls='--', marker='x', markevery=20, label="Imag, QASM")
