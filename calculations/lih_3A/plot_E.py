...
radii, E1_red_qasm = np.loadtxt('data/E1_red_sv1.dat').T#, dtype=complex, converters=converters).T
radii, E2_red_qasm = np.loadtxt('data/E2_red_sv1.dat').T#, dtype=complex, converters=converters).T
