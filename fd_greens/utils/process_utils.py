...
def take_01(arr: np.ndarray, circ_label: Optional[str] = None, reverse: bool = True) -> np.ndarray:
...
def process_berkeley_results(h5fname: str, circ_label: str, tomo_label: str, counts_name: str
                            ) -> None:
