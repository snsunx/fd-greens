...
omegas, lih_new_qasm, _ = np.loadtxt('data/lih_new_qasmd_TrSigma.dat').T
...
fig, ax = plt.subplots()
ax.plot(omegas, red_sv, label="Old")
ax.plot(omegas, lih_new_stat, ls='--', marker='x', markevery=20, label='New (SV)')
ax.plot(omegas, lih_new_qasm, ls='--', marker='x', markevery=20, label='New (QASM)')
