...
def plot_fidelity_by_depth(
    ...
    ax.plot(np.arange(len(depths_3q)), fidelities_3q, color='xkcd:medium blue', lw=lw, marker='.', ms=ms, label="iToffoli")
    ax.plot(np.arange(len(depths_2q)), fidelities_2q, color='xkcd:orange yellow', lw=lw, marker='.', ms=ms, label="CZ")
    ax.plot(locations_itoffoli, fidelities_itoffoli, ls='', color='xkcd:pinkish red', marker='x', ms=ms_itoffoli, mew=3.0)
